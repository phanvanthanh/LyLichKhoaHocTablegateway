...
CREATE TABLE IF NOT EXISTS `jos_admin_resource` (
  `resource_id` smallint(6) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Resource ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='Admin Resource Table';

-- Dumping data for table lylichkhoahoc.jos_admin_resource: ~27 rows (approximately)
/*!40000 ALTER TABLE `jos_admin_resource` DISABLE KEYS */;
INSERT INTO `jos_admin_resource` (`resource_id`, `parent_id`, `resource`, `resource_name`, `resource_type`, `resource_object`, `is_white_list`) VALUES
	(1, 0, 'Route', 'Route Module', 'Module', 'ACL', 0),
	(2, 1, 'Route\\Controller\\Route', 'Route\\Controller\\Route Controller', 'Controller', 'ACL', 0),
	(3, 2, 'index', 'index Action', 'Action', 'ACL', 0),
	(4, 0, 'Permission', 'Permission Module', 'Module', 'ACL', 0),
	(5, 4, 'Permission\\Controller\\User', 'Permission\\Controller\\User Controller', 'Controller', 'ACL', 0),
	(6, 5, 'index', 'index Action', 'Action', 'ACL', 0),
	(7, 5, 'login', 'login Action', 'Action', 'ACL', 1),
	(8, 5, 'logout', 'logout Action', 'Action', 'ACL', 1),
	(9, 4, 'Permission\\Controller\\Permission', 'Permission\\Controller\\Permission Controller', 'Controller', 'ACL', 0),
	(10, 9, 'index', 'index Action', 'Action', 'ACL', 0),
	(11, 9, 'update', 'update Action', 'Action', 'ACL', 0),
	(12, 0, 'Application', 'Application Module', 'Module', 'ACL', 0),
	(13, 12, 'Application\\Controller\\Index', 'Application\\Controller\\Index Controller', 'Controller', 'ACL', 0),
	(14, 13, 'index', 'index Action', 'Action', 'ACL', 0),
	(15, 13, 'view', 'view Action', 'Action', 'ACL', 1),
	(16, 0, 'CongTacNghienCuu', 'CongTacNghienCuu Module', 'Module', 'ACL', 0),
	(17, 16, 'CongTacNghienCuu\\Controller\\CongTacNghienCuu', 'CongTacNghienCuu\\Controller\\CongTacNghienCuu Controller', 'Controller', 'ACL', 0),
	(18, 17, 'index', 'index Action', 'Action', 'ACL', 0),
	(19, 0, 'NgoaiNgu', 'NgoaiNgu Module', 'Module', 'ACL', 0),
	(20, 19, 'NgoaiNgu\\Controller\\NgoaiNgu', 'NgoaiNgu\\Controller\\NgoaiNgu Controller', 'Controller', 'ACL', 0),
	(21, 20, 'index', 'index Action', 'Action', 'ACL', 0),
	(22, 0, 'MonHoc', 'MonHoc Module', 'Module', 'ACL', 0),
	(23, 22, 'MonHoc\\Controller\\MonHoc', 'MonHoc\\Controller\\MonHoc Controller', 'Controller', 'ACL', 0),
	(24, 23, 'index', 'index Action', 'Action', 'ACL', 0),
	(25, 0, 'NamHoc', 'NamHoc Module', 'Module', 'ACL', 0),
	(26, 25, 'NamHoc\\Controller\\NamHoc', 'NamHoc\\Controller\\NamHoc Controller', 'Controller', 'ACL', 0),
	(27, 26, 'index', 'index Action', 'Action', 'ACL', 0);
...
-- Dumping data for table lylichkhoahoc.jos_admin_role: ~3 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `jos_admin_rule` (
  ...
  `role_id` int(10) unsigned NOT NULL DEFAULT '1' COMMENT 'Role ID',
  `resource_id` smallint(6) unsigned NOT NULL DEFAULT '1' COMMENT 'Resource ID',
  PRIMARY KEY (`rule_id`),
...
-- Dumping data for table lylichkhoahoc.jos_admin_rule: ~0 rows (approximately)
...
-- Dumping structure for table lylichkhoahoc.jos_user_year_last_login
...
-- Dumping data for table lylichkhoahoc.jos_user_year_last_login: ~0 rows (approximately)
